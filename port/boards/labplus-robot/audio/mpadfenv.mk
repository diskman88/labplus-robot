...
ifdef CONFIG_ESP_LABPLUS_BOARD
INC_ESPCOMP += -I$(AUDIO)/driver
endif
...
INC_ESPCOMP += -I$(AUDIO)/lib/dueros
INC_ESPCOMP += -I$(AUDIO)/lib/dueros/dueros_service/include
INC_ESPCOMP += -I$(AUDIO)/lib/stream
